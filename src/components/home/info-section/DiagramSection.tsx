    ...
    <div className="lg:w-2/3 flex flex-col items-center">
      <div className="flex w-full items-center justify-between lg:justify-around gap-2 text-textColor text-sm pt-6">
        <div className="flex flex-col items-center">
          <p className="text-center text-nowrap lg:text-lg pb-4">
            Avant rachat de crédits
          </p>
          <Image src={before} alt="Graphique avant rachat de crédits" className="w-60" />
        </div>
        <div className="divider divider-horizontal before:bg-secondary before:w-[1px] after:bg-secondary after:w-[1px]"></div>
        <div className="flex flex-col items-center">
          <p className="text-center text-nowrap pb-4 lg:text-lg">
            Après rachat de crédits
          </p>
          <Image src={after} alt="Graphique après rachat de crédits" className="w-60" />
        </div>
      </div>
      <div className="flex items-center gap-5 lg:gap-10 text-textColor text-sm pt-6">

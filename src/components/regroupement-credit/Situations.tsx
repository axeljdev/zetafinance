const situations = [
  {
    title: "CAS 1 : J'AI BESOIN DE PLUS DE CONFORTBUDGÉTAIRE",
    description:
...
function Situations() {
  return (
    <section className="flex flex-col px-2">
      ...
      <ul className="flex flex-col justify-start gap-4 px-2 pb-4">
        {situations.map((situation, index) => (
          <li key={index} className="relative p-[0.3rem] rounded-2xl bg-gradient-button-light">
            <div className="flex flex-col bg-textColor rounded-xl p-4">
              <h3 className="font-semibold uppercase pb-10 text-lg after:absolute after:top-[5.5rem] after:left-5 after:w-10 after:h-[5px] after:bg-secondary">
                {situation.title}
              </h3>
        ...
        <li className="relative p-1 rounded-2xl bg-gradient-button-light">
          <div className="flex flex-col bg-textColor rounded-xl p-4">
            <h3 className="font-semibold uppercase pb-10 text-lg after:absolute after:top-[9rem] after:left-5 after:w-10 after:h-[5px] after:bg-secondary">

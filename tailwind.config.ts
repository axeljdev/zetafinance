    ...
    theme: {
      extend: {
        ...
        backgroundImage: {
          ...
          'gradient-card-light': "linear-gradient(350deg, rgba(255,141,92,1) 0%, rgba(241,67,44,1) 12%, rgba(233,18,12,1) 23%, rgba(230,0,0,1) 28%, rgba(215,3,3,1) 37%, rgba(174,14,14,1) 51%, rgba(159,19,19,1) 75%)",
        },
        boxShadow: {
